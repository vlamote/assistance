<html><head><title>RES.A.</title> <script language="javascript" type="text/javascript" src="datetimepicker.js"></script></head>
<table border="0" width="100%" id="table2"><tr>
<td width="22%"><font face="Verdana" size="1"><p align="left"><b>REServa d'Aules</b></font></p></td>
<td width="56%"><font face="Verdana" size="1" color="red"><p align="center"><b>1. Tria aula. 2. Tria data. 3. Prem el boto</b></p></td>
<td width="22%"><font face="Verdana" size="1"><p align="right"><b>RES.A.</b></p></font></td>
</tr></table><hr>
...
echo "<p align='center'><font face='Verdana' size='2' color='red'>Entre parentesi diu la capacitat maxima de l'aula</p>";
...
echo "
<form method='POST' action='horari_aula_llistat.php?idaula=$idaula'>
<select  name='idaula' class='select' >
	<option value=''>Tria aula</option>";
	$sql3="SELECT * FROM mdl_block_mrbs_room ORDER BY description";
	$result3=mysql_query($sql3, $conexion);
	while($row3=mysql_fetch_row($result3)){
		$compta_alumnes=$compta_alumnes+1;
		echo "<option value='$row3[0]'>$compta_alumnes: $row3[3] ($row3[4])</option>";
	}
echo "</select>";
