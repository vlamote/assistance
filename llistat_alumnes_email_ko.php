...
<td width="30%"><font face="Verdana" size="1"><p align="left"><b>LL.A.C.</b></font></p></td>
...
$sql="SELECT * FROM mdl_cohort WHERE idnumber LIKE '%ALUM%'";
...
$sql2="SELECT * FROM mdl_user WHERE id = '$row1[2]' AND (email LIKE '%hotmail%' OR email LIKE '%msn%' OR email LIKE '%outlook%')";
$result2=mysql_query($sql2, $conexion);
while($row2=mysql_fetch_row($result2)){
...
<td align='left' width='200px'><font face='Verdana' size='1'>$row2[11], $row2[10] ($row2[12])</font></td>
