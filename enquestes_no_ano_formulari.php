...
<title>B.ES.EN.</title></head><body bgcolor="#FFFFFF">
<table border="0" width="100%" id="table2"><tr>
<td width="22%"><font face="Verdana" size="1" color="black"><p align="left"><b>B.ES.EN.</b></p></td>
<td width="56%"><font face="Verdana" size="1" color="red"><p align="center"><b>Tria una enquesta i pica el boto</b></p></td>
<td width="22%"><font face="Verdana" size="1" color="black"><p align="right"><b>Bolcat EStadistiques ENquestes</b></font></p></td>
</tr></table><hr>
...
echo "<table  style='text-align: center margin-left: auto; margin-right: auto; width:100%; height: 44px;' border='0'>
  <tbody>
    <tr align='center'>
      <td width='100%'>	
      <form method='get' action='enquestes_no_ano_llistat.php?tipus=$tipus'>
        <font face='Arial' size='2'> 
        <select name='tipus'>
		<option value=''>1.- Tria enquesta</option>";
		$sql01 = "SELECT * FROM mdl_feedback WHERE TRUE ORDER BY name ASC";
