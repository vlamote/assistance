<html>
	...
	<body>
		<table border="0" width="100%" id="table2">
			<tr>
				<td width="22%"><font face="Verdana" size="1" color="black"><p align="left"><b>ES.PRO.</b></p></td>
				<td width="56%"><font face="Verdana" size="1" color="red"><p align="center"><b>Si no busques res en concret, deixa el camp <i>Cerca</i> en blanc.<br>Si no poses dates mirarà un mes en endavant</b></p></td>
				<td width="22%"><font face="Verdana" size="1" color="black"><p align="right"><b>Esdeveniments per  Professors</b></font></p></td>
			</tr>
		</table>
		<hr>
		...
		header('Location: http://iessitges.xtec.cat/login/index.php?id=284'); }
			...
			echo "<table  style='text-align: center margin-left: auto; margin-right: auto; width:100%; height: 44px;' border='0'>
				<tbody>
					<tr align='center'>
						<td width='100%'>
							<form method='get' action='esdeveniments_profes_llistat.php?data1=$data1&data2=$data2&pista=$pista'>								
								<font face='Arial' size='2'>Cerca: <input name='pista' id='pista' type='text' size='7'> entre ";
echo <<< HTML
...
HTML;
								echo"</font><input value='Mostra esdeveniments' type='submit'>
							</form>
						</td>
					</tr>
				</tbody>
