...
<td width="22%"><font face="Verdana" size="1"><p align="left"><b>TROBA.P.</b></font></p></td>
<td width="56%"><font face="Verdana" size="1" color="red"><p align="center"><b>1. Tria profe. 2. Prem el boto</b></p></td>
<td width="22%"><font face="Verdana" size="1"><p align="right"><b>TROBA Profe</b></p></font></td>
</tr></table><hr>
...
header('Location: http://iessitges.xtec.cat/login/index.php?id=284'); }
	...
	echo "<table  style='text-align: left margin-left: auto; margin-right: auto; width:100%; height: 44px;' border='0'>
		<tbody>
			<tr align='center'>
				<td width='100%'>
					<form method='POST' action='troba_profe_llistat.php'>
						<select  name='idalumne' class='select' >
							<option value=''>Tria un profe</option>";
							...
							while($row3=mysql_fetch_row($result3)){
								...
								$sql4="SELECT * FROM mdl_cohort a, mdl_cohort_members b WHERE ((a.idnumber LIKE 'PROFE') AND (b.userid='$idalumne') AND (b.cohortid=a.id))";
								$result4=mysql_query($sql4, $conexion);
								while($row4=mysql_fetch_row($result4)){
									$grup=$row4[3];
									$comptador=$comptador+1;
									echo "<option value='$idalumne'>$alumne</option>";
								}
							}
						...
						echo "<p align='center'><font face='Verdana' size='1' color='red'><br>$comptador professors</font></p>";
					echo "</form>
				</td>
			</tr>
		</tbody>
