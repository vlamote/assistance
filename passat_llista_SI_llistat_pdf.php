...
$registrespdf=unserialize($_POST['passat_llista_SI_llistat_pdf']);
...
$columnaordenada[$clau] = $fila[4]; //Selecciono la columna dels Alumnes per ordenar per nom i passem tots els valors a un nou array $columnaordenada...
