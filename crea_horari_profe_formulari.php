...
echo "
<p align='left'><font face='Verdana' size='2' color='red'><b>NOTES:</b><br><br>
...
7. Si, per qüestions d'estètica, <b>voleu posar-vos els forats del vostre horari</b>, trieu - - - als desplegables que correspongui -també al de l'aula!!-<br>
8. Els camps obligatoris són els que tenen un asterisc (*)<br>
...
2.- Ja no crea sessions els festius i vacances. Això fa que les estadístiques de sessions que es passa  llista o que no ja són fiables.<br>
</p>";
...
echo "
<form method='POST' action='crea_horari_profe_llistat.php'>
