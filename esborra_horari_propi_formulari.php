...
<td width="56%"><font face="Verdana" size="1" color="red">1. Tria materia 2. Tria assistencia 3. Tria grup 4. Tria dia 5. Tria hora 6. Tria aula 7. Prem el boto</p></td>
<td width="22%"><font face="Verdana" size="1"><p align="right"><b>Crea't l'HOrari Propi (C.HO.P.)</b></p></font></td>
</tr></table><hr>
...
while($row2=mysql_fetch_row($result2)){
	...
	echo "<p align='center'><b><font face='Verdana' size='2'>Esborrant horari de:</b> $alumne ($idalumne)<b><br></font></p>";
}
...
echo "
<form method='POST' action='esborra_horari_propi_llistat.php'>
