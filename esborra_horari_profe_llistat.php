...
if($existeix_sessio<>"" AND $ID_assistencia<>"" AND $ID_grup<>"" AND $dia<>"" AND $hora<>0 AND $durada<>""){
	...
	{	
		...
		$sql1 = "DELETE FROM mdl_attendance_sessions WHERE attendanceid='$ID_assistencia' AND groupid='$ID_grup' AND sessdate='$i' AND duration='$durada_sg' AND (lasttakenby='idalumne' OR lasttakenby='7')";
