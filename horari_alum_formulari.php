...
<td width="22%"><font face="Verdana" size="1"><p align="left"><b>HOR.AL.</b></font></p></td>
...
echo "
<form method='POST' action='horari_alum_llistat.php'>
...
echo "<br>";
echo <<< HTML
<input name="data1" id="data1" type="text" size="7" value="Tria data >>>>>>"><a href="javascript:NewCal('data1','ddmmmyyyy')"><img src="imatges/cal.gif" width="16" height="16" border="0" title="Tria una data"></a>
