<html><head><script language="javascript" type="text/javascript" src="datetimepicker.js"></script></head><title>INCID.IFO.</title></head>
	<body>
		<table border="0" width="100%" id="table2">
			<tr>
				<td width="22%"><font face="Verdana" size="1" color="black"><p align="left"><b>INCID.INFO.</b> | <a href="/mod/data/edit.php?d=28">Posar una incidència</a></p></td>
				<td width="56%"><font face="Verdana" size="1" color="red"><p align="center"><b>Si no es posa data mirarà una setmana en darrera</b></p></td>
				<td width="22%"><font face="Verdana" size="1" color="black"><p align="right"><b>INCIidències INFOrmàtiques</b></font></p></td>
			</tr>
		</table>
		<hr>
		...
		header('Location: http://iessitges.xtec.cat/login/index.php?id=284'); }
			...
			echo "<table  style='text-align: center margin-left: auto; margin-right: auto; width:100%; height: 44px;' border='0'>
				<tbody>
					<tr align='center'>
						<td width='100%'>
							<form method='get' action='incidencies_informatiques_llistat.php?data1=$data1&data2=$data2'>
