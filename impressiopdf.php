...
function Header()
{
	...
	$this->Cell(80);
	$this->Cell(180,10,utf8_decode("GESTIÓ REMOTA D'INCIDÈNCIES d'ALUMNES"),1,0,'C');
	$this->Ln(20);
}
...
$pdf = new PDF('L','mm','A4');  //Orientació horitzontal
$pdf->AliasNbPages();
$pdf->AddPage();

//Construïm els títols per cadasquna de les nostres columnes que formaran la taula pdf
$header=array('Data','Curs','Grup','Materia','Alumne','Incidencia');
